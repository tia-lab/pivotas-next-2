...
Scope: Craft change events, Next Data Cache tags, and Next/Vercel ISR
...
- Next/Vercel ISR for complete page responses

It intentionally does not use Redis, SQLite, or a custom dependency graph.
...
Vercel CDN hit. Only deployed response headers can prove the latter.
...
Run without Draft Mode cookies, the Vercel Toolbar cookie, or request
