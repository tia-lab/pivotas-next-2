...
- Vercel Git integration owns Next builds, previews, domains, and deployments.
- GitHub Actions validates the repository but does not deploy Craft or Next.
...
- Do not run Craft synchronization from commits, CI, releases, or Vercel builds.
