...
export interface LinkArrowProps extends TransitionLinkProps {
	title: string
}
...
export const LinkArrow = ({
	...
	return (
		<TransitionLink
			{...props}
			className={clsx($.link, externalClassName)}
			href={href}
			transition={transition}>
			<div className={clsx('text-caption', $.title)}>{title}</div>
			<div className={$.arrow_wrapper} data-arrow>
				<Arrow />
			</div>
		</TransitionLink>
	)
